...
public class LaunchUtils {
	public static Job launch(String output, String jobName, String filter,
			String dataset, Configuration fileConfig,
		...
		if (filter != null) {
			...
			Filter typeFilter = new SingleColumnValueFilter(
		...
		TableMapReduceUtil.initTableMapperJob(dataset, scan,
				...
				ImmutableBytesWritable.class, Result.class, fileJob);
		if (output == null) {
